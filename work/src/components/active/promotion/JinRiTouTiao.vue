<!--
  -- 推广落地页 - 今日头条特定需求页面，需要添加今日头条提供的统计代码
  —- @author bigfact
  -- @date 2017.04.12
  -->
<template>
  <section class="active-promotion-jinritoutiao">
    <!--banner-->
    <div>
      <img class="banner" src="../../../assets/active/promotion/banner-jiritoutiao.png"></img>
    </div>
    <!--数据提交表单-->
...
<script>
  ...
  export default {
    data() {
      // console.log($data.ids[sysinfo.getQueryString('channel')] || 0)
      // 按钮点击函数初始化
    ...
    ready() {
      ...
      // 添加今日头条的统计代码，使用的 js 方式，用户注册完成之后才触发统计
      // 转化代码分为两部分，基础代码复制并粘贴到网址代码的<head>和</head>之间，转化代码添加到相应的目标上
      // 基础代码:
      (function (root) {
