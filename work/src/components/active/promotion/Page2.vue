<!--
  ...
  -->
<template>
  <section class="active-promotion2">
    <!--banner-->
    <div>
      <img class="banner" src="../../../assets/active/promotion/page2_banner.png"></img>
    </div>
    <!--数据提交表单-->
...
<style lang="scss">
  ...
  .active-promotion2 {
    background: #FF3232 url('../../../assets/active/promotion/page2.png') no-repeat center top;
    ...
    button.btn {
      background: -webkit-gradient(linear, 0 0, 0 100%, from(#804FFD), to(#6235D4));
    }
    button.disabled {
      background: #DBDBDB;
      box-shadow: none;
