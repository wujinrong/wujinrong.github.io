<!--
  ...
  -->
<template>
  <section class="active-promotion-page9">
    <!--banner-->
    <div>
      <img class="banner" src="../../../assets/active/promotion/banner9.png"></img>
    </div>
    <!--数据提交表单-->
    <div class="form fs16" v-if="status != 1">
      <!--手机号码、短信验证码、登录密码  -->
      <div class="form-border tac">
        <!--手机号码-->
        <div class="tac">
          <div class="input-wrap tac">
      ...
      <!--提交按钮-->
      <div>
        <button :class="!agree && 'disabled'" class="btn page8-btn" v-submit="{cb: submitClick}">领取优惠券</button>
      </div>
    ...
    <div class="company-info tac fs14 c-white">
      <p class="addr">公司地址：上海市淞虹路207号明基商务广场C座2层</p>
