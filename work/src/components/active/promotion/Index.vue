<!--
  ...
  -->
<template>
  <section class="active-promotion">
    <!--banner-->
    <div class="banner-area" :class="type == 'jujiupei' && 'jujiupei-date'">
      <!--20170510 - 全部显示“拒就赔”的 banner-->
      <img class="banner" src="../../../assets/active/promotion/banner-jujiupei.png"></img>
    </div>
    <!--数据提交表单-->
